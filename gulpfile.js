...
var gulp = require('gulp'),
	...
	del = require('del');
	//路径
var pluginName = 'amazeui-validator',
	releasePath = 'gh-pages/release/',
	releaseSrc = 'dist/*.{css,js}',
	resDest = 'dist/',
	resSrc = 'src/',
	jsSrc = 'src/'+pluginName+'.js',
	jsMinName = pluginName+'.min.js',
	scssSrc = 'src/'+pluginName+'.scss',
	cssSrc = 'src/'+pluginName+'.css',
	cssMinName = pluginName+'.min.css',
	ghPagesSrc = '';
...
gulp.task('release',['css','js'],function() {
	return gulp.src(releaseSrc)
		.pipe(plugins.zip(pluginName+'.zip'))
